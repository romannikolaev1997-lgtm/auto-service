...
const services = [
  ...
  { icon: "⚙️", title: "Техобслуживание", desc: "Полное ТО по регламенту с заменой масел, фильтров, расходников и сезонным шиномонтажом." },
  ...
  { icon: "⚡", title: "Двигатель и КПП", desc: "Ремонт двигателей, замена ГРМ, диагностика и обслуживание коробки передач." },
